...
(* Represents a partial output from one of the parsing functions. If parsing is
   succesful, it represents an AST and the remaining token to be parsed.
   Otherwise, it is error message. *)
